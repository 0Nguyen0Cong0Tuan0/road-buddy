...
if __name__ == "__main__":
    ...
    saved_dir = "D:\\Learn\\Kaggle Competition\\Road-Buddy-Challenge\\data\\train"  # Change to your desired save directory
    download_video_in_file(saved_dir=saved_dir, json_file=os.path.join(script_dir, "public_test/public_test.json"))
    download_video_in_file(saved_dir=saved_dir, json_file=os.path.join(script_dir, "train/train.json"))